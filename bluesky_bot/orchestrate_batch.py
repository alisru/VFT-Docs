...
def run_phase1_baseline(llm_client, post_text):
    system_prompt = (
        ...
        "1. Stated intention is NOT an input; it is a claim to be verified. The actual effect chain produces the coordinates.\n"
        "2. p in p·t is a probability mass distribution over future states. Integration over time exposes the true trajectory.\n"
        "3. Positions: Good (passive Δ(p·t)>0), Bad (passive Δ(p·t)<0), Evil (active, premature contraction), Saintly (constructive will under active contraction pressure).\n"
        "4. Neutral is not flat: Conservative Neutral (restoring proven patterns) vs Innovative Neutral (exploring untested expansions).\n"
        "5. Scope caps: Single-person claims capped at ±0.5; community/group at ±1.0; systemic reach at ±2.0.\n"
        "6. ψ represents force direction of will (active/passive): +2.0 (Active-Active/Productive Justice), +1.0 (Proactive), 0.0 (Neutral), -1.0 (Passive Withholding), -2.0 (Active Destruction).\n"
        "7. Coercive or deceptive HOW forces ψ negative regardless of stated WHY.\n\n"
        ...
        "- trajectory (Canonical label: Grace, Fall, Deception, Delusion, Redemption, or Static)\n"
