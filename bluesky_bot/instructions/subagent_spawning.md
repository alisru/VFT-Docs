...
2. **Format the 13-Step Thread**: Construct exactly 13 posts following `thread_formatting.md`. Every post must target under 280 characters (hard limit of 299). The Hook (Element 0) MUST open with a punchy, human editorial one-liner. No dry prefixes.
