...
lines.append('**Artifact Location:** [luesky_bot/research_paper_structured_data_convergence_vs_vanilla.md](file:///e:/Vector%20Field%20Theory/VFT%20Docs/bluesky_bot/research_paper_structured_data_convergence_vs_vanilla.md)  ')
lines.append('**Dataset Source:** 10 Multi-Domain Live News Stories with 100% Full-Text Scrapes ([anilla_benchmark_10_stories.json](file:///e:/Vector%20Field%20Theory/VFT%20Docs/bluesky_bot/tests/vanilla_benchmark_10_stories.json))\n')
lines.append('---\n')
...
lines.append('In contrast, the **5-Phase Convergence Test ($ Tensor)** decouples rhetoric from physical causality, measuring directional force (\\upsilon, \\psi), ambiguity volume (z), and institutional hypocrisy (\\Delta H) with mathematical rigor.\n')
lines.append('---\n')
...
lines.append('* **\\upsilon Axis (Beneficiary / Morality):** Measures who captures value (+2.0 Systemic Justice -> -2.0 Pure Extraction).')
lines.append('* **\\psi Axis (Will / Energetic Vector):** Measures what the force is physically doing (+2.0 Productive Justice -> -2.0 Active Destruction).')
lines.append('* **z Axis (Ambiguity Volume):** The count of unpopulated context blanks across the 7 x 7 tensor (0 <= z <= 49).')
lines.append('* **Integrity Multiplier (R_net):** R_net = 1 / \\prod_{n=1}^7 V_{Qn}, exposing structural deception.')
...
lines.append('| :--- | :--- | :--- | :--- | :--- | :--- |')
lines.append('| **01** | **WA Police AI Face Cam** | 12,288 | (-0.90, -0.81, z=3) | Journalistic Essay Grading | *\"Rating: 9/10 (High Quality Journalism)\"* |')
lines.append('| **02** | **Amazon Deforestation Low** | 5,076 | (+1.00, +1.00, z=0) | Digest Tone Review | *\"Rating: 8.5/10 (Constructive Digest)\"* |')
lines.append('| **03** | **Apple Link 15% Fee Gate** | 3,912 | (-0.94, -0.87, z=2) | Timestamp Fixation | *\"Verdict: Fabricated / Synthetic (2026)\"* |')
lines.append('| **04** | **ACT Drug Decrim Debate** | 10,085 | (-1.00, -1.00, z=0) | Policy Balance Analysis | *\"Presents opposition alongside harm reduction\"* |')
lines.append('| **05** | **AI Boss Fires Human Worker** | 5,166 | (-0.12, +0.61, z=0) | Media Framing Analysis | *\"Rating: Real event, but sensationalized\"* |')
lines.append('| **06** | **AUKUS Submarine Sovereignty** | 7,550 | (-0.50, -1.00, z=18)| Balance Policing | *\"One-sided advocacy / Omits deterrence PR\"* |')
lines.append('| **07** | **Anthropic Export Ban** | 4,251 | (-1.20, -1.00, z=3) | Timestamp / Entity Rejection | *\"Fabricated / Speculative fiction\"* |')
lines.append('| **08** | **Alzheimer Sleep Breakthrough**| 8,667 | (+1.00, +1.00, z=0) | Science Writing Critique | *\"Rating: 7.5/10 (Headline misses \'in mice\')\"* |')
lines.append('| **09** | **Smelter .5B Bailout** | 5,112 | (-0.65, -0.62, z=3) | Metadata / Future Date Trap | *\"Verdict: Fictitious / Synthetic News\"* |')
lines.append('| **10** | **AIPAC PAC Campaign Spending** | 10,372 | (-0.54, -0.59, z=3) | Fact-Checking Discrepancies | *\"Verdict: Fake / Hallucinated Text\"* |\n')
lines.append('---\n')
...
print('SUCCESS: Updated paper with 100% full text data to:', paper_path)