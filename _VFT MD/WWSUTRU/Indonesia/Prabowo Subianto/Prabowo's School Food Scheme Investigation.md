# A Recipe for Risk: An In-Depth Analysis of Indonesia's Free Nutritious Meals (MBG) Program
...
## Section 1: The Political Genesis of a Flagship Policy
...
### Prabowo's Political Rebranding and Populist Platform
...
### The "Continuity" Mandate and Political Legacy
...
### A "Command and Control" Approach to Governance
...
## Section 2: Program Architecture and Key Actors
...
### The National Nutrition Agency (BGN): An Agency Without Authority
...
### Operational Units: The ***Satuan Pemenuhan Pelayanan Gizi*** (SPPG)
...
### Mapping the Ecosystem of Actors
...
**Table 2.1: Key Actors and Roles in the MBG Program**
...
## Section 3: A Timeline of Ambition and Failure (2024-Present)
...
### 4.2 The Governance Deficit and Oversight Failure
...
### 4.3 The Specter of Corruption and Cronyism
...
- **Documented Fraud and Investigations:** Evidence of corruption is not merely speculative; it has been documented by the nation's highest anti-graft body and even admitted by program officials.
  ...
  - The Corruption Eradication Commission (KPK) began formally studying the program and flagged significant irregularities. KPK Chairman Setyo Budiyanto cited reports of systemic portion reduction—for example, meals budgeted at Rp 10,000 were being delivered with a value of only Rp 8,000, with the difference likely being embezzled. This directly impacts food quality and nutrition.^14^

  - In a striking admission, a BGN official revealed a specific mode of fraud where the head of an SPPG colluded with a managing foundation to deliberately purchase poor-quality raw materials. By doing so, they were able to pocket the price difference, amounting to an illicit profit of Rp 20 million (approx. US\$1,200) per month from a single kitchen. The official confirmed that the SPPG head involved had been dismissed.^12^

  - Civil society groups, like the Alliance for Nutrition Program Oversight, leveled further allegations of systemic corruption, including the trading of "kitchen points" and schemes where prospective SPPG partners were required to pay between Rp 5 million and Rp 25 million to be verified.^38^

  - Indonesia Corruption Watch (ICW) provided a damning analysis, warning that the program's lack of transparency in procurement and the selection of SPPG partners created a high risk of conflicts of interest and turned the program into a vehicle for political patronage—a "bancakan politik" (political feast).^27^
...
### 4.4 The Militarization of a Social Program
...
## Section 5: The Government's Response: Reactive Measures vs. Systemic Reform
...
- **Public Apologies and Admissions:** Officials from the National Nutrition Agency (BGN), most notably Deputy Head Nanik S. Deyang, issued public apologies for the mass poisoning incidents. These statements acknowledged "negligence" and "weak oversight," serving as a necessary concession to public sentiment.^8^

- **Minimization and Reframing:** While BGN officials admitted fault at the operational level, President Prabowo consistently sought to minimize the scale of the crisis. His recurring claim of a "99.99 percent success rate" was a deliberate rhetorical strategy to frame thousands of poisonings as statistically insignificant outliers in a program serving millions.^8^ Similarly, after acknowledging "shortcomings" and "cases of food poisoning," he would immediately pivot to highlight the program's vast reach and job creation figures, arguing the benefits far outweighed the flaws.^25^

- **Promises of Compensation:** To address the immediate human impact, the government promised that the state health insurance agency (BPJS) would cover all medical costs for the victims of food poisoning, a move designed to demonstrate compassion and state responsibility without admitting to foundational policy failure.^5^
...
### A Preference for Technical Fixes
...
### The Unwillingness to Halt and Evaluate
...
## Section 6: Comparative Insights and International Best Practices
...
### Lessons from India's Midday Meal Scheme (MDMS)
...
- **A Strong Legal Framework:** Unlike the MBG, which was launched in a legal vacuum, the MDMS is anchored in national law, specifically the National Food Security Act, 2013.^51^ This legal mandate provides a solid foundation for the program, defining its objectives, entitlements, and the obligations of the state. This contrasts sharply with the MBG's reliance on the yet-to-be-issued authority of the BGN, which leaves the program vulnerable to arbitrary political directives and creates ambiguity in accountability.

- **A Multi-Tiered Monitoring Mechanism:** The MDMS features a structured, multi-layered monitoring system that extends from the national level down to the individual school and village.^51^ This includes national and state-level steering committees, district and municipal committees, and, crucially, school-level management committees that often include parents and teachers.^51^ This decentralized approach, while not always perfectly implemented, is designed to create channels for local feedback and oversight. The MBG, by contrast, has a highly centralized and opaque oversight structure dominated by the BGN, with little to no formal role for parents, teachers, or local community stakeholders in monitoring meal quality and delivery.^27^

- **Iterative, Decades-Long Development:** The MDMS did not emerge overnight as a universal program. Its roots trace back to a 1925 initiative in Tamil Nadu, and it evolved through decades of state-level experiments before being adopted nationwide in 1995 and significantly expanded in 2001.^51^ This long, iterative process allowed for learning and adaptation. The MBG's "big bang" approach, attempting to go from concept to full national scale in under a year, bypassed this crucial phase of piloting and institutional learning, leading to predictable and widespread failures. While the MDMS demonstrates that a legal framework and monitoring system are not panaceas for corruption, their absence in the MBG program has undoubtedly exacerbated its problems, leaving it without even the basic institutional tools to identify and address them.

### Benchmarking Against World Food Programme (WFP) Standards
...
2.  **Establish a Robust Legal and Regulatory Framework:** Before any resumption of the program, the government must draft and enact a comprehensive Presidential Regulation (*Peraturan Presiden*). This foundational legal document must, at a minimum:

    - Clearly define the legal authority, responsibilities, and accountability mechanisms of the National Nutrition Agency (BGN).

    - Establish transparent, competitive, and legally binding procurement regulations for all levels of the supply chain to prevent collusion and conflicts of interest.

    - Mandate legally enforceable food safety standards based on established international systems like Hazard Analysis and Critical Control Points (HACCP).

    - Create clear and unambiguous lines of accountability for all actors, from national agencies to local kitchen operators, with defined sanctions for non-compliance.

3.  **Demilitarize and Decentralize Implementation:** The role of the Indonesian National Military (TNI) and National Police (Polri) in kitchen operations and food distribution should be phased out and their functions transferred to civilian entities. The program's implementation model must be fundamentally decentralized. Primary responsibility for local execution should be devolved to local governments (provincial and district), which are better positioned to understand local needs and contexts. This must be paired with a renewed and genuine commitment to a "home-grown school feeding" model, empowering local MSMEs, farmer cooperatives, and community-based organizations through transparent and accessible procurement processes.

4.  **Implement a Multi-Layered, Participatory Oversight System:** The current top-down, opaque oversight structure must be dismantled and replaced with a multi-layered system that incorporates checks and balances at every level. Modeled on successful international examples like India's MDMS, this system should include:

    - **National Level:** Oversight by the BGN (with its new legal mandate), the Ministry of Health, and the Food and Drug Supervisory Agency (BPOM).

    - **Regional Level:** Active monitoring by provincial and district health and education offices.

    - **School Level:** The establishment of mandatory School Meal Monitoring Committees at every participating school, comprising the school principal, teachers, and, crucially, parent representatives. These committees must be empowered to conduct daily quality checks and report issues through a formal, protected channel.

    - **Civil Society:** Formal inclusion of independent civil society organizations and community monitors to provide an external layer of accountability.

5.  **Adopt a Phased, Evidence-Based Rollout:** Upon resumption, the program must abandon its universalist "big bang" approach. It should be reintroduced gradually and strategically, following a phased, evidence-based model.

    - **Prioritize High-Need Areas:** The initial rollout should focus exclusively on regions with the highest rates of poverty, stunting, and food insecurity (such as the 3T areas—frontier, outermost, and disadvantaged).

    - **Mandatory Certification:** No kitchen or region should be permitted to join the program until its kitchens, staff, and supply chains have been independently audited and certified as meeting the new, legally mandated safety and operational standards.

    - **Quality over Quantity:** The program's expansion must be contingent on demonstrated success and capacity at the existing scale. The guiding principle must shift from maximizing the number of beneficiaries served to maximizing the quality and safety of every meal delivered.

#### Works cited

1.  President Prabowo: Free Nutritious Meal Program is Investment for Nation's Future - Sekretariat Kabinet Republik Indonesia, accessed October 15, 2025, [[https://setkab.go.id/en/president-prabowo-free-nutritious-meal-program-is-investment-for-nations-future/]{.underline}](https://setkab.go.id/en/president-prabowo-free-nutritious-meal-program-is-investment-for-nations-future/)

2.  Indonesia food poisoning: More than 1,000 children ill after school lunch - YouTube, accessed October 15, 2025, [[https://www.youtube.com/watch?v=MhpNCk093gE]{.underline}](https://www.youtube.com/watch?v=MhpNCk093gE)

3.  President Prabowo Affirms Commitment to Build Healthy, Smart Generation - Sekretariat Kabinet Republik Indonesia, accessed October 15, 2025, [[https://setkab.go.id/en/president-prabowo-affirms-commitment-to-build-healthy-smart-generation/]{.underline}](https://setkab.go.id/en/president-prabowo-affirms-commitment-to-build-healthy-smart-generation/)

4.  MBG to Realize a Better Nutrition Standard for All Children: BGN - INP Polri, accessed October 15, 2025, [[https://inp.polri.go.id/artikel/mbg-to-realize-a-better-nutrition-standard-for-all-children-bgn]{.underline}](https://inp.polri.go.id/artikel/mbg-to-realize-a-better-nutrition-standard-for-all-children-bgn)

5.  DPR member says issues with free nutritious meals program reasonable, accessed October 15, 2025, [[https://en.antaranews.com/news/386145/dpr-member-says-issues-with-free-nutritious-meals-program-reasonable]{.underline}](https://en.antaranews.com/news/386145/dpr-member-says-issues-with-free-nutritious-meals-program-reasonable)

6.  Free meals program spends Rp20.6 tln, covers 31.2 mln people: ministry, accessed October 15, 2025, [[https://en.antaranews.com/news/386044/free-meals-program-spends-rp206-tln-covers-312-mln-people-ministry]{.underline}](https://en.antaranews.com/news/386044/free-meals-program-spends-rp206-tln-covers-312-mln-people-ministry)

7.  Indonesia's free meal ambition: When policy becomes a recipe for ..., accessed October 15, 2025, [[https://www.lowyinstitute.org/the-interpreter/indonesia-s-free-meal-ambition-when-policy-becomes-recipe-risk]{.underline}](https://www.lowyinstitute.org/the-interpreter/indonesia-s-free-meal-ambition-when-policy-becomes-recipe-risk)

8.  Food Poisoning Outbreaks Heap Pressure on Indonesia's Free Meal ..., accessed October 15, 2025, [[https://thediplomat.com/2025/09/food-poisoning-outbreaks-heap-pressure-on-indonesias-free-meal-program/]{.underline}](https://thediplomat.com/2025/09/food-poisoning-outbreaks-heap-pressure-on-indonesias-free-meal-program/)

9.  Indonesia's ambitious free meals programme under fire after food ..., accessed October 15, 2025, [[https://www.channelnewsasia.com/asia/indonesia-free-nutritious-meals-programme-prabowo-food-poisioning-outbreaks-5379411]{.underline}](https://www.channelnewsasia.com/asia/indonesia-free-nutritious-meals-programme-prabowo-food-poisioning-outbreaks-5379411)

10. Where has Indonesia's optimism gone? - Lowy Institute, accessed October 15, 2025, [[https://www.lowyinstitute.org/the-interpreter/debate/where-has-indonesia-s-optimism-gone]{.underline}](https://www.lowyinstitute.org/the-interpreter/debate/where-has-indonesia-s-optimism-gone)

11. Military ensures strict supervision to prevent MBG food poisoning - ANTARA News, accessed October 15, 2025, [[https://en.antaranews.com/news/382717/military-ensures-strict-supervision-to-prevent-mbg-food-poisoning]{.underline}](https://en.antaranews.com/news/382717/military-ensures-strict-supervision-to-prevent-mbg-food-poisoning)

12. KPK Ready To Investigate Allegations Of Misappropriation Of MBG After BGN Talks About SPPG Fraud Mode - VOI, accessed October 15, 2025, [[https://voi.id/en/news/522497]{.underline}](https://voi.id/en/news/522497)

13. KPK Intervenes To Study MBG Program And Will Issue Recommendations - VOI, accessed October 15, 2025, [[https://voi.id/en/news/523934]{.underline}](https://voi.id/en/news/523934)

14. KPK Flags Irregularities in Indonesia's \$4 Billion Free Meal Program - Jakarta Globe, accessed October 15, 2025, [[https://jakartaglobe.id/news/kpk-flags-irregularities-in-indonesias-4-billion-free-meal-program]{.underline}](https://jakartaglobe.id/news/kpk-flags-irregularities-in-indonesias-4-billion-free-meal-program)

15. Prabowo Subianto's Apparent Election in Indonesia: Considerations for Congress, accessed October 15, 2025, [[https://www.congress.gov/crs-product/IN12328]{.underline}](https://www.congress.gov/crs-product/IN12328)

16. Prabowo Subianto - Wikipedia, accessed October 15, 2025, [[https://en.wikipedia.org/wiki/Prabowo_Subianto]{.underline}](https://en.wikipedia.org/wiki/Prabowo_Subianto)

17. THE 2024 INDONESIAN ELECTIONS: PRABOWO'S LIKELY VICTORY AND A REAL TEST FOR DEMOCRACY - Transparency International Indonesia, accessed October 15, 2025, [[https://ti.or.id/the-2024-indonesian-elections-prabowos-likely-victory-and-a-real-test-for-democracy/]{.underline}](https://ti.or.id/the-2024-indonesian-elections-prabowos-likely-victory-and-a-real-test-for-democracy/)

18. Prabowo Subianto claims victory in Indonesian presidential election - Al Jazeera, accessed October 15, 2025, [[https://www.aljazeera.com/news/2024/2/14/prabowo-subianto-claims-victory-in-indonesian-presidential-election]{.underline}](https://www.aljazeera.com/news/2024/2/14/prabowo-subianto-claims-victory-in-indonesian-presidential-election)

19. Indonesia Elections 2024: What does a Prabowo presidency mean?, accessed October 15, 2025, [[https://www.edelmanglobaladvisory.com/indonesia-elections-2024-what-does-prabowo-presidency-mean]{.underline}](https://www.edelmanglobaladvisory.com/indonesia-elections-2024-what-does-prabowo-presidency-mean)

20. Prabowo Subianto 2024 presidential campaign - Wikipedia, accessed October 15, 2025, [[https://en.wikipedia.org/wiki/Prabowo_Subianto_2024_presidential_campaign]{.underline}](https://en.wikipedia.org/wiki/Prabowo_Subianto_2024_presidential_campaign)

21. Analysis: Prabowo sees free nutritious meal program as glass half full - The Jakarta Post, accessed October 15, 2025, [[https://www.thejakartapost.com/opinion/2025/08/27/analysis-prabowo-sees-free-nutritious-meal-program-as-glass-half-full.html]{.underline}](https://www.thejakartapost.com/opinion/2025/08/27/analysis-prabowo-sees-free-nutritious-meal-program-as-glass-half-full.html)

22. 100 Days of Prabowo-Gibran Special Report - National - magz, accessed October 15, 2025, [[https://magz.tempo.co/read/national/42748/100-days-of-prabowo-gibran-special-report]{.underline}](https://magz.tempo.co/read/national/42748/100-days-of-prabowo-gibran-special-report)

23. Armed forces enter Indonesia's food production battle - East Asia Forum, accessed October 15, 2025, [[https://eastasiaforum.org/2025/05/06/armed-forces-enter-indonesias-food-production-battle/]{.underline}](https://eastasiaforum.org/2025/05/06/armed-forces-enter-indonesias-food-production-battle/)

24. Press Release: Nutritious Meals Program to reach schools today in Indonesia, accessed October 15, 2025, [[https://schoolmealscoalition.org/stories/press-release-nutritious-meals-program-reach-schools-today-indonesia]{.underline}](https://schoolmealscoalition.org/stories/press-release-nutritious-meals-program-reach-schools-today-indonesia)

25. In Prabowo's First Year, MBG Feeds 30 Million and Boosts Local Economies - Jakarta Globe, accessed October 15, 2025, [[https://jakartaglobe.id/news/in-prabowos-first-year-mbg-feeds-30-million-and-boosts-local-economies]{.underline}](https://jakartaglobe.id/news/in-prabowos-first-year-mbg-feeds-30-million-and-boosts-local-economies)

26. Why Calls to Suspend Prabowo's Free Nutritious Meal Program Are Growing Louder, accessed October 15, 2025, [[https://en.tempo.co/read/2050852/why-calls-to-suspend-prabowos-free-nutritious-meal-program-are-growing-louder]{.underline}](https://en.tempo.co/read/2050852/why-calls-to-suspend-prabowos-free-nutritious-meal-program-are-growing-louder)

27. MBG: Anggaran Jumbo Minim Transparansi - Aktual.com, accessed October 15, 2025, [[https://aktual.com/mbg-anggaran-jumbo-minim-transparansi/]{.underline}](https://aktual.com/mbg-anggaran-jumbo-minim-transparansi/)

28. BGN taps local MSMEs to supply MBG kitchens in West Papua, accessed October 15, 2025, [[https://en.antaranews.com/news/386023/bgn-taps-local-msmes-to-supply-mbg-kitchens-in-west-papua]{.underline}](https://en.antaranews.com/news/386023/bgn-taps-local-msmes-to-supply-mbg-kitchens-in-west-papua)

29. Hundreds hit with food poisoning in Indonesia after eating free ..., accessed October 15, 2025, [[https://www.theguardian.com/world/2025/aug/15/hundreds-struck-by-poisoned-in-indonesia-after-eating-free-meals-from-presidents-flagship-program]{.underline}](https://www.theguardian.com/world/2025/aug/15/hundreds-struck-by-poisoned-in-indonesia-after-eating-free-meals-from-presidents-flagship-program)

30. Blora Police MBG kitchen serves 2,515 children across 28 schools, accessed October 15, 2025, [[https://en.antaranews.com/news/385925/blora-police-mbg-kitchen-serves-2515-children-across-28-schools]{.underline}](https://en.antaranews.com/news/385925/blora-police-mbg-kitchen-serves-2515-children-across-28-schools)

31. Prabowo launches police-run free meals kitchens nationwide - ANTARA News, accessed October 15, 2025, [[https://en.antaranews.com/news/363169/prabowo-launches-police-run-free-meals-kitchens-nationwide]{.underline}](https://en.antaranews.com/news/363169/prabowo-launches-police-run-free-meals-kitchens-nationwide)

32. Indonesia's free school meals programme under scrutiny as 5000 children fall ill, accessed October 15, 2025, [[https://www.independent.co.uk/asia/southeast-asia/indonesia-food-poisoning-free-school-meals-b2834049.html]{.underline}](https://www.independent.co.uk/asia/southeast-asia/indonesia-food-poisoning-free-school-meals-b2834049.html)

33. Indonesia faces calls to halt free meals program as over 5000 school children fall ill, accessed October 15, 2025, [[https://apnews.com/article/indonesia-students-free-meals-poisoning-102a48c3296bfbb42d4d6bcf1bc8716f]{.underline}](https://apnews.com/article/indonesia-students-free-meals-poisoning-102a48c3296bfbb42d4d6bcf1bc8716f)

34. Shark dish backlash prompts BGN to reaffirm MBG food safety - ANTARA News, accessed October 15, 2025, [[https://en.antaranews.com/news/382513/shark-dish-backlash-prompts-bgn-to-reaffirm-mbg-food-safety]{.underline}](https://en.antaranews.com/news/382513/shark-dish-backlash-prompts-bgn-to-reaffirm-mbg-food-safety)

35. Food safety alert: Ombudsman calls for tighter oversight of MBG - ANTARA News, accessed October 15, 2025, [[https://en.antaranews.com/news/383441/food-safety-alert-ombudsman-calls-for-tighter-oversight-of-mbg]{.underline}](https://en.antaranews.com/news/383441/food-safety-alert-ombudsman-calls-for-tighter-oversight-of-mbg)

36. President admits flaws in free meal program, orders stricter safety measures, accessed October 15, 2025, [[https://indonesiabusinesspost.com/5339/policy/president-admits-flaws-in-free-meal-program-orders-stricter-safety-measures]{.underline}](https://indonesiabusinesspost.com/5339/policy/president-admits-flaws-in-free-meal-program-orders-stricter-safety-measures)

37. BGN deploys 5,000 chefs to strengthen free meal kitchens nationwide, accessed October 15, 2025, [[https://en.antaranews.com/news/385369/bgn-deploys-5000-chefs-to-strengthen-free-meal-kitchens-nationwide]{.underline}](https://en.antaranews.com/news/385369/bgn-deploys-5000-chefs-to-strengthen-free-meal-kitchens-nationwide)

38. Nutrition Oversight Alliance Demands Probe Into BGN, Cites Alleged Irregularities in Free Nutrition Program - Jakarta Daily, accessed October 15, 2025, [[https://www.jakartadaily.id/local/16216063373/nutrition-oversight-alliance-demands-probe-into-bgn-cites-alleged-irregularities-in-free-nutrition-program]{.underline}](https://www.jakartadaily.id/local/16216063373/nutrition-oversight-alliance-demands-probe-into-bgn-cites-alleged-irregularities-in-free-nutrition-program)

39. Nutrition Agency reports 4700 cases of illness linked to free meals program, accessed October 15, 2025, [[https://indonesiabusinesspost.com/5283/national-resilience/nutrition-agency-reports-4-700-cases-of-illness-linked-to-free-meals-program]{.underline}](https://indonesiabusinesspost.com/5283/national-resilience/nutrition-agency-reports-4-700-cases-of-illness-linked-to-free-meals-program)

40. Stress-related physiological changes and post-release survival of elephant fish (Callorhinchus milii) after longlining, gillnetting, angling and handling in a controlled setting \| Request PDF - ResearchGate, accessed October 15, 2025, [[https://www.researchgate.net/publication/345148545_Stress-related_physiological_changes_and_post-release_survival_of_elephant_fish_Callorhinchus_milii_after_longlining_gillnetting_angling_and_handling_in_a_controlled_setting]{.underline}](https://www.researchgate.net/publication/345148545_Stress-related_physiological_changes_and_post-release_survival_of_elephant_fish_Callorhinchus_milii_after_longlining_gillnetting_angling_and_handling_in_a_controlled_setting)

41. Trends in Marine Resources and Fisheries Management in Indonesia - CEA Consulting, accessed October 15, 2025, [[https://www.ceaconsulting.com/wp-content/uploads/Indonesia-Marine-Full-Report-CEA-2018.pdf]{.underline}](https://www.ceaconsulting.com/wp-content/uploads/Indonesia-Marine-Full-Report-CEA-2018.pdf)

42. Corruption in Indonesia - Wikipedia, accessed October 15, 2025, [[https://en.wikipedia.org/wiki/Corruption_in_Indonesia]{.underline}](https://en.wikipedia.org/wiki/Corruption_in_Indonesia)

43. Indonesia - Transparency International Knowledge Hub, accessed October 15, 2025, [[https://knowledgehub.transparency.org/country/indonesia]{.underline}](https://knowledgehub.transparency.org/country/indonesia)

44. Pragmatism, Greed, and Systemic Failures: Deep-Rooted Causes of Corruption in Indonesia, accessed October 15, 2025, [[https://ugm.ac.id/en/news/pragmatism-greed-and-systemic-failures-deep-rooted-causes-of-corruption-in-indonesia/]{.underline}](https://ugm.ac.id/en/news/pragmatism-greed-and-systemic-failures-deep-rooted-causes-of-corruption-in-indonesia/)

45. Financial Crimes - Indonesia Business Post, accessed October 15, 2025, [[https://indonesiabusinesspost.com/financial-crimes]{.underline}](https://indonesiabusinesspost.com/financial-crimes)

46. ICW Calls for Halt to Free Nutritious Meal Project Due to Various Problems, accessed October 15, 2025, [[https://en.tempo.co/read/1998592/icw-calls-for-halt-to-free-nutritious-meal-project-due-to-various-problems]{.underline}](https://en.tempo.co/read/1998592/icw-calls-for-halt-to-free-nutritious-meal-project-due-to-various-problems)

47. Indonesia's MBG program should be paused after poisonings, economists say - APSN, accessed October 15, 2025, [[https://www.asia-pacific-solidarity.net/news/2025-09-29/indonesias-mbg-program-should-be-paused-after-poisonings-economists-say.html]{.underline}](https://www.asia-pacific-solidarity.net/news/2025-09-29/indonesias-mbg-program-should-be-paused-after-poisonings-economists-say.html)

48. MBG Drives Forward Economy and Boost Students Competency: Prabowo Says - INP Polri, accessed October 15, 2025, [[https://inp.polri.go.id/artikel/mbg-drives-forward-economy-and-boost-students-competency-prabowo-says]{.underline}](https://inp.polri.go.id/artikel/mbg-drives-forward-economy-and-boost-students-competency-prabowo-says)

49. In Prabowo's Indonesia, the military is quietly creeping back into civilian life - The Guardian, accessed October 15, 2025, [[https://www.theguardian.com/world/2025/aug/28/indonesia-president-prabowo-subianto-military-civilian-affairs]{.underline}](https://www.theguardian.com/world/2025/aug/28/indonesia-president-prabowo-subianto-military-civilian-affairs)

50. Indonesia's Free School Lunches: Not So Free \| FULCRUM, accessed October 15, 2025, [[https://fulcrum.sg/indonesias-free-school-lunches-not-so-free/]{.underline}](https://fulcrum.sg/indonesias-free-school-lunches-not-so-free/)

51. Midday Meal Scheme - Wikipedia, accessed October 15, 2025, [[https://en.wikipedia.org/wiki/Midday_Meal_Scheme]{.underline}](https://en.wikipedia.org/wiki/Midday_Meal_Scheme)

52. Mid Day Meal Scheme in India: A Complete Guide \| Ketto, accessed October 15, 2025, [[https://www.ketto.org/blog/mid-day-meal-scheme]{.underline}](https://www.ketto.org/blog/mid-day-meal-scheme)

53. Impact of free school lunch program on nutritional status and academic outcomes among school children in India: A systematic review - PubMed Central, accessed October 15, 2025, [[https://pmc.ncbi.nlm.nih.gov/articles/PMC11256073/]{.underline}](https://pmc.ncbi.nlm.nih.gov/articles/PMC11256073/)

54. The State of School Feeding Worldwide \| World Food Programme, accessed October 15, 2025, [[https://www.wfp.org/publications/state-school-feeding-worldwide]{.underline}](https://www.wfp.org/publications/state-school-feeding-worldwide)

55. School meals \| World Food Programme, accessed October 15, 2025, [[https://www.wfp.org/school-meals]{.underline}](https://www.wfp.org/school-meals)

56. School Meals Coalition \| A healthy meal every day for every child, accessed October 15, 2025, [[https://schoolmealscoalition.org/]{.underline}](https://schoolmealscoalition.org/)

57. School Meals - World Food Program USA, accessed October 15, 2025, [[https://www.wfpusa.org/work/programs/school-meals/]{.underline}](https://www.wfpusa.org/work/programs/school-meals/)

58. Program Makan Bergizi Gratis (MBG): Menyongsong Indonesia Emas 2045, accessed October 15, 2025, [[http://bpmpprovsumut.kemendikdasmen.go.id/program-makan-bergizi-gratis-mbg-menyongsong-indonesia-emas-2045/]{.underline}](http://bpmpprovsumut.kemendikdasmen.go.id/program-makan-bergizi-gratis-mbg-menyongsong-indonesia-emas-2045/)

59. Developing a School Feeding Program \| The Global FoodBanking Network, accessed October 15, 2025, [[https://www.foodbanking.org/resources/developing-a-school-feeding-program/]{.underline}](https://www.foodbanking.org/resources/developing-a-school-feeding-program/)

60. Supporting Children Worldwide: Our School Feeding Programme \| Tetra Pak Global, accessed October 15, 2025, [[https://www.tetrapak.com/sustainability/focus-areas/food-access-availability-and-resilience/school-feeding-programmes]{.underline}](https://www.tetrapak.com/sustainability/focus-areas/food-access-availability-and-resilience/school-feeding-programmes)

61. Makan Bergizi Gratis dan SDM Unggul - Sekretariat Negara, accessed October 15, 2025, [[https://www.setneg.go.id/baca/index/makan_bergizi_gratis_dan_sdm_unggul]{.underline}](https://www.setneg.go.id/baca/index/makan_bergizi_gratis_dan_sdm_unggul)

62. Program Makan Bergizi Gratis Dorong Pembangunan Ekonomi Daerah - Kementerian Pendayagunaan Aparatur Negara dan Reformasi Birokrasi, accessed October 15, 2025, [[https://www.menpan.go.id/site/berita-terkini/berita-daerah/program-makan-bergizi-gratis-dorong-pembangunan-ekonomi-daerah]{.underline}](https://www.menpan.go.id/site/berita-terkini/berita-daerah/program-makan-bergizi-gratis-dorong-pembangunan-ekonomi-daerah)
