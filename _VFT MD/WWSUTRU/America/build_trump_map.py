...
<body class="antialiased text-gray-800">
    ...
    <div class="explainer" style="max-width: 800px; margin: 0 auto 2rem auto; background: #ffffff; padding: 2rem; border-radius: 16px; border: 1px solid #e2e8f0; text-align: left; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1);">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; font-size: 0.9rem; color: #334155; align-items: start;">
            <div style="background: #f8fafc; padding: 1rem; border-radius: 8px;">
                <strong style="color: #0f172a; display: block; margin-bottom: 0.5rem; font-size: 1rem;">X-Axis: Moral (υ)</strong>
                <span style="color: #16a34a; font-weight: 700;">Left (+1)</span>: Universal Benefit<br>
                <span style="color: #dc2626; font-weight: 700;">Right (-1)</span>: Self Benefit
            </div>
            <div style="background: #f8fafc; padding: 1rem; border-radius: 8px;">
                <strong style="color: #0f172a; display: block; margin-bottom: 0.5rem; font-size: 1rem;">Y-Axis: Will (ψ)</strong>
                <span style="color: #16a34a; font-weight: 700;">Top (+1)</span>: Proactive/Creative<br>
                <span style="color: #dc2626; font-weight: 700;">Bottom (-1)</span>: Suppressive/Passive
            </div>
        </div>
