...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (min-width: 800px) { .canvas-container.zoomed-container { justify-content: center; } .zoom-hint { display: none !important; } }
    ...
    <script>
        ...
        canvas.addEventListener('touchstart', (e) => {
            if (e.touches.length > 0) {
                ...
                if (timesince < 300 && timesince > 0 && window.innerWidth < 800) {
