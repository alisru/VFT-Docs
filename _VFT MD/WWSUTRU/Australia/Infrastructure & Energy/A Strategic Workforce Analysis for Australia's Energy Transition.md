...
## **1. Deconstructing the NEN's Total Workforce Demand**
...
### **1.1. The Headline Figures: 150,000 Direct and 300,000 Indirect Jobs**
...
### **1.2. Primary Employment Categories**
...
- **Installation & Deployment:** This is the largest and most labour-intensive component of the project. It encompasses the field workforce responsible for the physical rollout of solar systems to approximately 11 million households. Key roles include accredited electricians for final connections and compliance, teams of installation technicians for mechanical work such as racking and panel mounting, surveyors for the initial data acquisition phase, and dedicated specialist teams for more complex installations on apartments and heritage-listed properties.^1^

- **Sovereign Manufacturing:** A cornerstone of the NEN's economic strategy is the creation of a domestic manufacturing base. This requires a new, highly skilled industrial workforce. Roles will include chemical engineers and materials scientists for the Sodium-Ion battery gigafactories, process technicians and robotics specialists for automated production lines, and skilled trades such as mechanical fitters and metal fabricators for the expanded transformer production and panel assembly plants.^1^

- **Logistics & Project Management:** The sheer scale of the NEN necessitates a sophisticated national logistics and management structure. This category includes a diverse range of white-collar and skilled blue-collar roles within the central NEN Authority and its decentralised hubs. These roles cover procurement and contract management, quality assurance and component testing, warehousing and inventory control, national distribution and transport logistics, and overall project management and administration.^1^

- **Long-Term Operations & Maintenance (O&M):** After the nine-year construction phase, a permanent workforce will be required for the ongoing operation of the network. This includes grid controllers and software engineers managing the AI-driven smart grid and Virtual Power Plant (VPP), cybersecurity specialists, field technicians for predictive and reactive maintenance on 11 million systems and 50,000 NEN Nodes, and personnel for the "evergreen" component replacement and panel recycling programs.^1^

### **1.3. Benchmarking and Validation**
...
## **2. Annual Workforce Projections (Years 1-9): A Phased Mobilisation**
...
- **Installation Team Structure:** An average installation team is assumed to consist of three to four members. This typically includes one Clean Energy Council (CEC) accredited electrician responsible for the final, compliant connection, supported by two to three installers or trade assistants responsible for the mechanical aspects of the installation, such as mounting racks and panels.^6^

- **Labour Productivity:** It is assumed that an average team can complete one standard 6.6 kW residential installation per day. This productivity rate is expected to improve during the peak deployment phases (Years 4-6) as teams gain proficiency, supply chains mature, and the AI-driven logistics and scheduling platform becomes fully operational, minimising on-site delays.^1^

- **Working Days:** The model assumes approximately 250 working days per year, accounting for weekends, public holidays, and typical leave periods.

### **2.2. Year-by-Year Workforce Breakdown**
...
#### **Phase 1: Foundation & Scaling (Years 1-3)**
...
- **Year 1 (Foundational Year):** With a target of 250,000 installations, this year requires the mobilisation of an initial field workforce of approximately **3,000-4,000** installers and electricians.^1^ Concurrently, foundational teams must be established within the NEN Authority to manage legislation, procurement, and the national data acquisition program. This includes surveyors, logistics planners, and administrative staff.

- **Year 2 (Initial Ramp-Up):** The installation target triples to 750,000 homes.^1^ Consequently, the field workforce must also triple to an estimated
  **9,000-12,000** personnel. This year represents a critical test of the national training strategy, requiring a massive expansion of apprenticeship intakes and VET course offerings in partnership with TAFEs to build the pipeline of skilled workers.^1^ The first domestic manufacturing retrofits are also scheduled to begin, initiating demand for construction and engineering roles for industrial retooling.^1^

- **Year 3 (Acceleration):** The installation target doubles to 1,500,000 homes.^1^ The field workforce must double in parallel, reaching
  **18,000-24,000**. As the AI logistics platform becomes fully operational and the supply of critical components like transformers stabilises, productivity is expected to increase. The first wave of repurposed manufacturing facilities begins to come online, requiring the recruitment of the initial cohort of specialised manufacturing workers for panel and battery assembly.^1^

#### **Phase 2: Mass Deployment & Subsidy Activation (Years 4-7)**
...
- **Year 4 (Peak Deployment):** The installation rate reaches its peak of 2,500,000 homes for the year.^1^ The field workforce swells to its maximum required level, estimated at
  **30,000-40,000** people. This figure represents the point of maximum strain on the national supply of skilled trades, particularly electricians. The newly built domestic manufacturing plants are expected to be fully operational, employing thousands in production roles.

- **Year 5 (Sustained Peak):** The peak installation rate of 2,500,000 is maintained, requiring the retention of the peak workforce.^1^ A significant milestone is reached as the NEN network begins generating substantial revenue from grid services. This necessitates the recruitment of the first permanent operational staff for the Virtual Power Plant (VPP) control centre, grid management, and commercial operations.^1^

- **Year 6 (Consolidation & Taper):** The installation rate begins a managed taper, with a target of 2,000,000 homes.^1^ The installation workforce is reduced to approximately
  **24,000-32,000**. The project's focus begins to shift towards more complex and remote installations, such as multi-unit dwellings and heritage homes, which require dedicated specialist teams with different skill sets.^1^

- **Year 7 (Universal Coverage):** With a final installation target of approximately 1,840,000 homes, the workforce continues its gradual taper.^1^ A formal and structured program to transition experienced installation staff into long-term Operations & Maintenance (O&M) roles commences, ensuring the retention of valuable skills within the NEN ecosystem.^1^

#### **Phase 3: Completion & Optimisation (Years 8-9)**
...
- **Years 8-9 (Optimization & Full Operation):** The installation program concludes in Year 7. The large-scale construction and installation workforce is largely demobilised or fully transitioned into new roles. The permanent workforce for O&M, grid management, software development, and the NEN's commercial arm stabilises at its long-term, sustainable level.
...
**Table 1: NEN Annual Installation and Workforce Ramp-Up (Years 1-9)**
...
## **3. The Sovereign Manufacturing Imperative: Building a New Industrial Workforce**
...
### **3.1. Stream A (Build): Sodium-Ion Battery "Virtual Gigafactory"**
...
### **3.2. Stream B (Partner): Core Transformer Manufacturing**
...
### **3.3. Stream C (Innovate): In-House AI and Grid-Tech Development**
...
## **4. Feasibility Analysis: Sourcing the NEN Workforce**
...
### **4.1. The National Skills Shortage Landscape**
...
- **Electrotechnology and Trades:** The most acute challenge lies in sourcing the tens of thousands of electricians required for the installation phase. The 2023 Skills Priority List, a key national benchmark, identified 100% of Construction Trades Worker occupations and 73% of Electrotechnology and Telecommunications Trades Worker occupations as being in national shortage.^2^ This finding is echoed in the NSW Renewable Energy Workforce Plan, which specifically highlights shortages of electricians and metal trades workers as a primary risk to the state's renewable energy ambitions.^5^

- **Engineering Professionals:** The NEN requires a broad spectrum of engineering expertise, from civil and structural engineers for construction to electrical and power systems engineers for grid integration and manufacturing. The 2023 Skills Priority List also found that 100% of Engineering Professionals occupations are in national shortage.^2^ The JSA's 2023 analysis noted that newly emerging shortages were concentrated among high-skilled professional occupations, including Biomedical and Electrical Engineers.^9^
...
### **4.2. VET System Capacity and Constraints**
...
- **Trainer and Assessor Shortages:** A critical bottleneck exists at the source of skills creation. There is a chronic national shortage of qualified electrical teachers and VET trainers. This is largely because experienced tradespeople can earn significantly more in industry than in teaching roles. This shortage directly impacts training capacity, with reports of electrical apprentice training being delayed by up to 18 months, which extends apprenticeship completion times and further constrains the supply of qualified workers.^7^

- **Resource and Funding Gaps:** Decades of underfunding have limited the ability of many TAFEs and other Registered Training Organisations (RTOs) to invest in the modern equipment and infrastructure required for clean energy training. As a result, many RTOs do not offer the relevant elective units for renewable energy within the electrotechnology training package because it is cheaper to deliver more common units.^7^

- **Government Initiatives:** The Australian Government has recognised these challenges and is implementing initiatives to address them. This includes a \$91 million investment to scale up clean energy apprenticeships, \$30 million to expand the clean energy teacher and trainer workforce, and the establishment of a network of TAFE Centres of Excellence focused on renewables.^10^ While these initiatives are vital, the sheer scale of the NEN's demand will test their limits and require a level of coordination and investment far beyond current commitments.

### **4.3. Competition for Labour**
...
### **4.4 A Proposed Solution: The 'Solar Installation (Restricted) Licence'**
...
This new licence would be a more advanced and specialised version, with its scope strictly limited to the electrical wiring and commissioning of residential solar PV and battery systems. It would not permit general electrical work.^13^ A theoretical, intensive training program could produce a fully competent and licensed solar installer in

**15 to 18 months**, structured as follows:

- **Component 1: Foundational Electrical and Safety Training (6 months):** An intensive, full-time TAFE course covering the essential safety and theory components of a full apprenticeship. This would include a deep understanding of AC/DC principles, comprehensive training on the AS/NZS 3000 Wiring Rules, and mandatory safety certifications like Working Safely at Heights and CPR/LVR.^15^

- **Component 2: Specialised Solar and Battery Training (3 months):** A focused block of training dedicated to the specific standards for solar and battery installation, primarily AS/NZS 5033 and AS/NZS 4777. This would involve hands-on training in the mandatory sequence of tests required to safely commission a system.^17^

- **Component 3: Supervised Practical Apprenticeship (9 months):** A mandatory, paid apprenticeship where the trainee works directly under the supervision of a fully licensed and accredited electrician. The trainee would be required to complete a logbook with a significant number of real-world installations to demonstrate competency before being signed off for their restricted licence.
...
**Table 2: Critical Skills Demand vs. National Shortage Analysis**
...
## **5. A Just Transition: Integrating Australia's Existing Energy Workforce**
...
### **5.1. The Fossil Fuel Workforce: Scale and Demographics**
...
- **Coal Mining:** This is the largest sub-sector. IBISWorld and the Minerals Council of Australia report approximately 50,600 people employed in coal mining in a recent year.^19^ Data from CEIC shows a similar figure of 49,669.^22^ The Australian Bureau of Statistics (ABS) provides a more conservative estimate from its Labour Account data, showing 34,300 people employed in 2021–22.^23^

- **Oil and Gas Extraction:** According to CEIC data, this sub-sector employed approximately 22,534 people in early 2025.^24^ Energy Producers Australia, an industry body, estimates the sector underpins around 80,000 direct and indirect jobs, though direct employment is lower.^25^

- **Gas Supply and Refining:** Smaller cohorts are employed in downstream activities. The gas supply industry employed approximately 2,078 people in 2024, while petroleum and coal product manufacturing employed around 4,725 as of early 2025.^26^
...
### **5.2. Skills Transferability and Retraining Needs**
...
- **Directly Transferable Skills:** Many roles require minimal retraining. Electricians, mechanical engineers, project managers, health and safety managers, heavy machinery operators, and civil engineers possess core competencies that are directly applicable to the construction and maintenance of renewable energy infrastructure.^7^ These workers can transition with only minor, targeted upskilling on technology-specific systems.

- **Retraining and Upskilling Requirements:** For other roles, more substantial retraining will be necessary. A technician from a coal-fired power station, for example, possesses deep knowledge of power generation systems but would require specific VET-level qualifications in solar inverter technology, battery management systems, or wind turbine maintenance to transition effectively. The NEN proposal explicitly acknowledges this need and commits to funding dedicated retraining and upskilling programs in partnership with TAFEs and other training providers.^1^

### **5.3. Geographical and Structural Challenges**
...
**Table 3: Fossil Fuel Workforce vs. NEN Opportunities – A Skills Transfer Matrix**
...
## **6. The "Evergreen" Workforce: Sustaining Employment Beyond Year 9**
...
### **6.1. The Dual Replacement Cycles**
...
- **Solar Panel Replacement Cycle:** Solar panels have a typical operational lifespan of 25 to 30 years. The NEN will install approximately 176 million panels across the country. As these panels reach their end-of-life, they will need to be decommissioned, recycled, and replaced. This creates a permanent annual replacement market for approximately 6 to 7 million panels, which translates to a continuous demand for around 2,800 MW of new panel manufacturing and installation work every year, indefinitely.^1^

- **Inverter and Electronics Replacement Cycle:** The high-value electronic components of the system, particularly the smart inverters, have a shorter replacement cycle of 10 to 15 years.^1^ This creates a more frequent and substantial wave of ongoing work. The replacement of 11 million household inverters over a 15-year cycle necessitates the manufacture and installation of over 730,000 new units each year. This high-frequency cycle for high-value electronics will be the primary engine of stable, long-term employment for electricians and technicians across the country.
...
### **6.2. Operations, Maintenance, and Optimisation**
...
### **6.3. The Compounding Surplus and Future Growth**
...
### **7.1. Launch a National Clean Energy Training Initiative Incorporating an Accelerated Solar Licence**
...
### **7.2. Reform the VET System for Agility**
...
### **7.3. Implement Targeted Skilled Migration**
...
### **7.4. Establish a National Transition Authority**
...
### **7.5. Drive Industry Partnerships and Diversity**
...
1.  [[v2 National Energy Network]{.underline}](https://docs.google.com/document/d/1NP1t6TMxVK6f0gU_Xx6MZLoO0ps7MTRQBebtQSbMouU/edit?usp=sharing)

2.  Renewable energy - powering jobs and regional communities, accessed July 17, 2025, [[https://cleanenergycouncil.org.au/getmedia/d1238b95-5b2c-412b-b84b-1c3d7ea549f8/Renewable-energy-jobs-and-regional-communities.pdf]{.underline}](https://cleanenergycouncil.org.au/getmedia/d1238b95-5b2c-412b-b84b-1c3d7ea549f8/Renewable-energy-jobs-and-regional-communities.pdf)

3.  Rooftop Solar Vs Utility Scale Solar - LA Solar Group, accessed July 17, 2025, [[https://la-solargroup.com/rooftop-solar-vs-utility-scale-solar/]{.underline}](https://la-solargroup.com/rooftop-solar-vs-utility-scale-solar/)

4.  Census Solar Job Trends - Interstate Renewable Energy Council (IREC), accessed July 18, 2025, [[https://irecusa.org/census-solar-job-trends/]{.underline}](https://irecusa.org/census-solar-job-trends/)

5.  NSW 2030 Renewable Energy Workforce Plan - NSW Department of ..., accessed July 18, 2025, [[https://education.nsw.gov.au/content/dam/main-education/skills/renewable-energy/renewable-energy-workforce-plan-consultation-draft.pdf]{.underline}](https://education.nsw.gov.au/content/dam/main-education/skills/renewable-energy/renewable-energy-workforce-plan-consultation-draft.pdf)

6.  The Best Home Batteries In Australia In 2025: According To Aussie Installers - Solar Quotes, accessed July 19, 2025, [[https://www.solarquotes.com.au/blog/best-home-batteries-2025/]{.underline}](https://www.solarquotes.com.au/blog/best-home-batteries-2025/)

7.  Response to Jobs and Skills Australia's Discussion Paper, accessed July 18, 2025, [[https://www.jobsandskills.gov.au/sites/default/files/2023-09/12.%20Energy%20Skills%20Australia.pdf]{.underline}](https://www.jobsandskills.gov.au/sites/default/files/2023-09/12.%20Energy%20Skills%20Australia.pdf)

8.  Quinbrook to build polysilicon factory in Australia - PV Magazine, accessed July 17, 2025, [[https://www.pv-magazine.com/2024/03/25/quinbrook-to-build-polysilicon-factory-in-australia/]{.underline}](https://www.pv-magazine.com/2024/03/25/quinbrook-to-build-polysilicon-factory-in-australia/)

9.  Towards a National Jobs and Skills Roadmap. Annual Jobs and ..., accessed July 18, 2025, [[https://www.jobsandskills.gov.au/sites/default/files/2023-11/JSA%20annual%20report%20-%20summary.pdf]{.underline}](https://www.jobsandskills.gov.au/sites/default/files/2023-11/JSA%20annual%20report%20-%20summary.pdf)

10. Skilling up Australia's clean energy workforce \| Ministers' Media Centre, accessed July 18, 2025, [[https://ministers.dewr.gov.au/giles/skilling-australias-clean-energy-workforce]{.underline}](https://ministers.dewr.gov.au/giles/skilling-australias-clean-energy-workforce)

11. Restricted electrical licence - Government of Western Australia, accessed July 19, 2025, [[https://www.wa.gov.au/government/multi-step-guides/restricted-electrical-licence]{.underline}](https://www.wa.gov.au/government/multi-step-guides/restricted-electrical-licence)

12. Electrical licence - restricted - Consumer Building and Occupational Services, accessed July 19, 2025, [[https://www.cbos.tas.gov.au/topics/licensing-and-registration/licensed-occupations/electrical/restricted]{.underline}](https://www.cbos.tas.gov.au/topics/licensing-and-registration/licensed-occupations/electrical/restricted)

13. Restricted Electrical Worker's licence (REL) - Energy Safe Victoria, accessed July 19, 2025, [[https://www.energysafe.vic.gov.au/licensing/electrical-licences/licence-types/restricted-electrical-workers-licence-rel]{.underline}](https://www.energysafe.vic.gov.au/licensing/electrical-licences/licence-types/restricted-electrical-workers-licence-rel)

14. restricted electrical license for trades : r/AusElectricians - Reddit, accessed July 19, 2025, [[https://www.reddit.com/r/AusElectricians/comments/1iw95cj/restricted_electrical_license_for_trades/]{.underline}](https://www.reddit.com/r/AusElectricians/comments/1iw95cj/restricted_electrical_license_for_trades/)

15. Solar Panel Installation Certification - What's Required? - Electro-training Institute, accessed July 19, 2025, [[https://www.electrotraining.com.au/solar-panel-installation-certification-what-s-required/]{.underline}](https://www.electrotraining.com.au/solar-panel-installation-certification-what-s-required/)

16. Solar Accreditation Australia – Get Accredited: no worries, accessed July 19, 2025, [[https://saaustralia.com.au/]{.underline}](https://saaustralia.com.au/)

17. Guide for solar panel installers - Consumer and Business Services, accessed July 19, 2025, [[https://www.cbs.sa.gov.au/documents/Solar-Panels-Factsheet.pdf]{.underline}](https://www.cbs.sa.gov.au/documents/Solar-Panels-Factsheet.pdf)

18. Information for electrical licence holders - Government of Western Australia, accessed July 19, 2025, [[https://www.wa.gov.au/organisation/building-and-energy/information-electrical-licence-holders]{.underline}](https://www.wa.gov.au/organisation/building-and-energy/information-electrical-licence-holders)

19. www.ibisworld.com, accessed July 18, 2025, [[https://www.ibisworld.com/australia/employment/coal-mining/14770/#:\~:text=There%20was%2050%2C600%20people%20employed,in%20Australia%20as%20of%202024.]{.underline}](https://www.ibisworld.com/australia/employment/coal-mining/14770/#:~:text=There%20was%2050%2C600%20people%20employed,in%20Australia%20as%20of%202024.)

20. Coal - Minerals Council of Australia, accessed July 18, 2025, [[https://minerals.org.au/about/mining-facts/mineral-coal/]{.underline}](https://minerals.org.au/about/mining-facts/mineral-coal/)

21. Coal Mining in Australia Employment Statistics \| IBISWorld, accessed July 18, 2025, [[https://www.ibisworld.com/australia/employment/coal-mining/14770/]{.underline}](https://www.ibisworld.com/australia/employment/coal-mining/14770/)

22. Australia Employment: Mining: Coal Mining \| Economic Indicators - CEIC, accessed July 18, 2025, [[https://www.ceicdata.com/en/australia/employment-by-sex-and-by-industry/employment-mining-coal-mining]{.underline}](https://www.ceicdata.com/en/australia/employment-by-sex-and-by-industry/employment-mining-coal-mining)

23. Employment trends in coal mining and the renewable energy sector - Parliament of Australia, accessed July 18, 2025, [[https://www.aph.gov.au/About_Parliament/Parliamentary_departments/Parliamentary_Library/Research/Research_Papers/2022-23/EmploymentTrendsCoalMiningRenewableEnergy]{.underline}](https://www.aph.gov.au/About_Parliament/Parliamentary_departments/Parliamentary_Library/Research/Research_Papers/2022-23/EmploymentTrendsCoalMiningRenewableEnergy)

24. Australia Employment: Mining: Oil & Gas Extraction \| Economic Indicators - CEIC, accessed July 18, 2025, [[https://www.ceicdata.com/en/australia/employment-by-sex-and-by-industry/employment-mining-oil--gas-extraction]{.underline}](https://www.ceicdata.com/en/australia/employment-by-sex-and-by-industry/employment-mining-oil--gas-extraction)

25. Oil and gas explained - Industry benefits - Australian Energy Producers, accessed July 18, 2025, [[https://energyproducers.au/industry/oil-and-gas-explained/industry-benefits-2/]{.underline}](https://energyproducers.au/industry/oil-and-gas-explained/industry-benefits-2/)

26. Gas Supply in Australia Employment Statistics \| IBISWorld, accessed July 18, 2025, [[https://www.ibisworld.com/australia/employment/gas-supply/301/]{.underline}](https://www.ibisworld.com/australia/employment/gas-supply/301/)

27. Australia Employment: Manufacturing: Petroleum & Coal Product \| Economic Indicators, accessed July 18, 2025, [[https://www.ceicdata.com/en/australia/employment-by-sex-and-by-industry/employment-manufacturing-petroleum--coal-product]{.underline}](https://www.ceicdata.com/en/australia/employment-by-sex-and-by-industry/employment-manufacturing-petroleum--coal-product)

28. 5\. Building a skilled, diverse and safe offshore decommissioning workforce, accessed July 18, 2025, [[https://www.industry.gov.au/publications/australias-offshore-resources-decommissioning-roadmap/5-building-skilled-diverse-and-safe-offshore-decommissioning-workforce]{.underline}](https://www.industry.gov.au/publications/australias-offshore-resources-decommissioning-roadmap/5-building-skilled-diverse-and-safe-offshore-decommissioning-workforce)

29. SKILLING THE ENERGY TRANSITION, accessed July 18, 2025, [[https://assets.cleanenergycouncil.org.au/documents/CEC_Skilling-the-Energy-Transition-2022.pdf]{.underline}](https://assets.cleanenergycouncil.org.au/documents/CEC_Skilling-the-Energy-Transition-2022.pdf)

30. Skilling The Energy Transition Report Provides Solutions To Australia's Skills And Labour Challenges, accessed July 18, 2025, [[https://cleanenergycouncil.org.au/news-resources/skilling-the-energy-transition-report-provides-solutions-to-australias-skills-and-labour-challenges]{.underline}](https://cleanenergycouncil.org.au/news-resources/skilling-the-energy-transition-report-provides-solutions-to-australias-skills-and-labour-challenges)

31. Skilling the energy transition \| VOCEDplus, the international tertiary education and research database, accessed July 18, 2025, [[https://www.voced.edu.au/content/ngv%3A95405]{.underline}](https://www.voced.edu.au/content/ngv%3A95405)

32. VET Workforce Blueprint Project - Powering Skills Organisation, accessed July 18, 2025, [[https://poweringskills.com.au/project/vet-workforce-blueprint-project/]{.underline}](https://poweringskills.com.au/project/vet-workforce-blueprint-project/)

33. Skilling the workforce for energy transition - KPMG Australia, accessed July 18, 2025, [[https://kpmg.com/au/en/home/insights/2024/03/human-capital-management-energy-transition-workforce.html]{.underline}](https://kpmg.com/au/en/home/insights/2024/03/human-capital-management-energy-transition-workforce.html)
