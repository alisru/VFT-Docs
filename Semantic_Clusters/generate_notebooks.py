...
def classify_by_topic(rel_path, file_name, text_sample=""):
    ...
    if "chatlog" in path_lower or "muses" in path_lower or "drawing_board" in path_lower or "notes" in name_lower or "temporary" in name_lower:
    ...
    if "io" in path_lower:
        return "Unstructured Notes & Chat Logs"
    return "Metaphysics & Actualism" # General philosophy default
